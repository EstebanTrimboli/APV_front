  ...
  return (
    <>
        ...
        <p className="text-xl mt-5 mb-10 text-center">
            Editá tu <span className="text-indigo-600 font-bold">información</span>
        </p>
          ...
          <div className="w-full md:w-1/2 bg-white shadow rounded-lg p-5 border-4 border-indigo-100">
            ...
            <form
             onSubmit={handleSubmit}>
              ...
              className="bg-indigo-700 px-10 py-3 font-bold text-white text-item rounded-lg uppercase w-full mt-5 hover:cursor-pointer hover:bg-indigo-800" />
